...
Project timeline:
- Start: Jan 30, 2024, 6:00 AM
- End: Jan 31, 2024, 6:00 AM
- Checker release: Jan 30, 2024, 12:00 PM
- Auto review at the deadline

### Concepts

In this project, you'll be working with Regular Expressions using the Oniguruma library, which is the default regex library for Ruby.

Here is the sample Ruby code template for regex usage:
...
This exercise has been prepared for you by Guillaume Plessis, VP of Infrastructure at TextMe. It is a real-world scenario that he encounters daily. You can express your gratitude to Guillaume for sharing this project on Twitter.
